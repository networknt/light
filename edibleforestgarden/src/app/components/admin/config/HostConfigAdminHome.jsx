...
import HostConfigAdminStore from '../../../stores/HostConfigAdminStore';
import ConfigActionCreators from '../../../actions/ConfigActionCreators';
import FormActionCreators from '../../../actions/FormActionCreators';

var HostConfigAdminHome = React.createClass({
    displayName: 'HostConfigAdminHome',
    ...
    componentWillMount: function() {
        HostConfigAdminStore.addChangeListener(this._onConfigChange);
        ConfigActionCreators.getAllHostConfig();
    },

    componentWillUnmount: function() {
        HostConfigAdminStore.removeChangeListener(this._onConfigChange);
    },

    _onConfigChange: function() {
        this.setState({
            configs: HostConfigAdminStore.getConfigs()
        });
    },

    _onDeleteConfig: function(config) {
        ConfigActionCreators.delHostConfig(config['@rid']);
    },

    _onUpdateConfig: function(config) {
        let formId = 'com.networknt.light.host.config.update';
    ...
    _onAddConfig: function() {
        let formId = 'com.networknt.light.host.config.add';
        this.context.router.push('/form/' + formId);
    },
...
module.exports = HostConfigAdminHome;
