...
const id = 'com.networknt.light.forum.post.add';

var ForumPostAdd = React.createClass({
    ...
    _onFormChange: function() {
        ...
        console.log('ForumPostAdd._onFormChange', schema, form, action, category['@rid']);
        this.setState({
            schema: schema,
            form: form,
            action: action,
    ...
    _onTouchTap: function(action) {
        ...
        if(!validationResult.valid) {
            ...
            ForumActionCreators.addPost(action);
        }
    },
