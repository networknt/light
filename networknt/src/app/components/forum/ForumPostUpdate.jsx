...
const id = 'com.networknt.light.forum.post.update';

var ForumPostUpdate = React.createClass({
    ...
    _onFormChange: function() {
        ...
        this.setState({
            ...
            form: form,
            action: action,
            model: CommonUtils.findPost(ForumStore.getPosts(), this.props.params.entityId)
        });
    },
    ...
    _onTouchTap: function(action) {
        ...
        if(!validationResult.valid) {
            ...
            ForumActionCreators.updPost(action);
        }
    },
...
module.exports = ForumPostUpdate;
